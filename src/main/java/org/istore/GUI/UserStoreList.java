...
public class UserStoreList extends JPanel {

    public UserStoreList(String storeId) {
        Dotenv dotenv = Dotenv.configure().load();
        Listing listingQueries = new Listing();

        JFrame userListFrame = new JFrame(String.format(dotenv.get("PROJECT_NAME")) + " - User list from a store");
        ...
        ArrayList<ArrayList<String>> userList = listingQueries.getUserStoreList(storeId);

        String header[] = {"ID", "Email", "Pseudo", "Role", "Whitelisted", "Store"};
